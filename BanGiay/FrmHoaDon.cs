...
namespace BanGiay
{
    public partial class FrmHoaDon : Form
    {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Shop Bán quần áo Thành Đạt";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Bình Tân -- TP.HCM";
            ...
            tblThongtinHD = DataDL.GetDataToTable(sql);
            ...
            tblThongtinHang = DataDL.GetDataToTable(sql);
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            using (DBGEntities db = new DBGEntities())
            {
                var KH = db.tblCTHDs.Where(kh => kh.MaHoaDon.Equals(txtTimKiem.Text)).FirstOrDefault();
                if (KH != null)
                {
